...
public class task6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Answer 1 = " + hiddenAnagram("My world evolves in a beautiful space called Tesh.",
                "sworn love lived"));
        System.out.println("Answer 2 = " + collect("intercontinentalisationalism", 6));
        System.out.println("Answer 3 = " + nicoCipher("myworldevolvesinhers", "tesh"));
        System.out.println("Answer 4 = " + Arrays.toString(twoProduct(new int[]{1, 2, 3, 9, 4, 15, 3, 5}, 45)));
        ...
        System.out.println("Answer 10 = " + Arrays.deepToString(sumsUp(var10000)));
